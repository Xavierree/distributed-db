...
class StoreNodeGyu:
    def __init__(self):
        ...
        self.url = os.environ.get("SUPABASE_URL_B") or os.environ.get("NEXT_PUBLIC_STORE_B_URL")
        self.key = os.environ.get("SUPABASE_KEY_B") or os.environ.get("NEXT_PUBLIC_STORE_B_KEY")
    ...
    def process_computation(self, category_request, agg_type):
        ...
        if category_request == "ALL":
             ...
             # Assumes view_transaction_details exists
